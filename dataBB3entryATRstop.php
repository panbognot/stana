<?php 
	...
	// returns BB3 Buy Signal and ATR based Sell/Stop Signal
	//		{(timestamp, bb3), (timestamp, signal)}
	function getBB3entryATRstop ($company, $from="1900-01-01 00:00:00", $to=null, 
					$dataorg="json", $samplePeriod=15, $enSignals=false,
					$enJsonEncode="false", $enProfitComputation=true,
					$host, $db, $user, $pass) {
		...
		//TODO:Tailor data for the BB3 input
		//Input for BB3 functions should be [timestamp,...]
/*		$ctr = 0;
		$dataOhlcForSMA = [];
